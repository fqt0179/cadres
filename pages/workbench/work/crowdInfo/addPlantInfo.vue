<template>
	<view class="add-plant-info">
		...
		<view class="item">
			<view class="label uni-flex">
				<text class="important-mark">*</text>
				<text class="txt">采摘时间</text>
			</view>
			<view class="value-box uni-flex">
				<input class="input" type="text" value="开始时间" />
				<text class="rung">—</text>
				<input class="input" type="text" value="结束时间" />
			</view>
		</view>
		<view class="item">
			<view class="label uni-flex">
	...
	export default {
		...
		methods: {
			...
			pickerChange: function(e) {
				...
				this.whereList[index].index = e.target.value
			},
			getDate(type) {
				const date = new Date();
